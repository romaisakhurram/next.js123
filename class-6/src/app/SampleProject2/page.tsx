import style from "@/app/SampleProject2/page.module.css"
...
export default function SampleProject2 () {
    return (
         <div className={style.SampleProjectContainer}>
              <h1 className={style.h1}>Sample Project 2</h1>
              <div className={style.Image1}>
                <Image src={image33} alt="image" width={1170} height={435}/>
              </div>
              <br />
              <div className={style.Image2}>
                <Image src={image34} alt="image" width={450} height={200} id="Image"/>
