export default function About () {
    return (
        <div>
            ...
            <h1 className="h1">2.My Web Development Journey</h1>   
             ...
             - I Study ADC part 1 From Shaheed e Millat Govt Degree College and I am enrolled In GIAIC (Goverment Iniatiative Of Artificial Intelligence).
            </p>
            
            <h1 className="h1">3.My Skills and Expertise</h1>
